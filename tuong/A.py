...
class Projectile(pygame.sprite.Sprite):
    def __init__(self, speed, start_pos, target_pos):
        super().__init__()
        self.surf = pygame.image.load("assets\Attacks\A.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
...
class first_attack(pygame.sprite.Sprite):
    def __init__(self, speed, start_pos, target_pos):
        super().__init__()
        self.surf = pygame.image.load("assets/Skills/A/0.png").convert()
        self.surf.set_colorkey((255, 255, 255), RLEACCEL)
        self.rect = self.surf.get_rect(center=start_pos)
        self.speed = speed
        self.start_pos_x = start_pos[0]
...
while running:
    ...
    A.update(left_click, middle_click, right_click)
    if right_click:
        A.normal_attack()
